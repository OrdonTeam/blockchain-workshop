...
contract SignedOffChainPactContractWithEvents {

    event PactConfirmed(address one, address other, address pactId);
    ...
    function confirmPact(address one, address other, address pactId) private {
        ...
        addConfirmedPact(one, other, pactId);
    }
    ...
    function addConfirmedPact(address one, address other, address pactId) private {
